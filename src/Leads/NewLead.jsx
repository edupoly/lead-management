                ...
                return <div style={{width:'70%',marginLeft:'200px'}}>
                    <Form>
                            ...
                            <div className='d-flex'>
                                <div className="form-floating mb-3 col-5" style={{marginRight:'150px'}}>
                            ...
                            <div className='d-flex'>
                                <div className="form-floating mb-3 col-3" style={{marginRight:'112px'}}>
                        ...
                        <button className='btn btn-secondary px-5' style={{marginLeft:'370px'}}>Submit</button>
                    </Form>
                </div>
            }
          } 
